...
#include <stdio.h>
#include <stdlib.h>
//This stores the total number of bookc in each shelf
int* total_number_of_books;

//This store the total number of pages in each book of each shelf,
...
for(int i; i<total_number_of_shelves;i++){
